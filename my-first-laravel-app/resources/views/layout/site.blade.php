...
<nav>
    <div class="main-wrapper">
        <div class="flex-container">
            <a class="logotipo" href="{{route('home')}}">
                <img src="{{asset('images/Asset 1.svg')}}">
            </a>
            <ul class="navigation__itens" id="menu">
                <li>
                    <a href="{{route('home')}}">Página principal
                ...
                <li>
                    <a href="{{route('about')}}">Sobre
                        <span class="border-effect"></span>
                    </a>
                </li>
                <li>
                    <a href="{{route('contact.index')}}">Contato
                        <span class="border-effect"></span>
                    </a>
                </li>
            </ul>
...
<div id="resize">
    <ul id="menu">
        <li><a class="title-medium" href="{{route('home')}}">Página principal</a></li>
        <li><a class="title-medium" href="{{route('site.products')}}">Produtos</a></li>
        <li><a class="title-medium" href="{{route('blog')}}">Blog</a></li>
        <li><a class="title-medium" href="{{route('about')}}">Sobre</a></li>
        <li><a class="title-medium" href="{{route('contact.index')}}">Contato</a></li>
    </ul>
</div>
    ...
    <div class="main-wrapper flex-container">
        ...
        <ul>
            ...
            <li class="footer__links">
                ...
                <a href="{{route('contact.index')}}">Entre em contato</a>
            </li>
            <li class="footer__links">
